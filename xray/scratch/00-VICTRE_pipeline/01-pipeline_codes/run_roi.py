...
#fetch_seed = 1700001
phantom_type = 'hetero'
fetch_seed = 421760580
#phantom_type = 'scattered'
#fetch_seed = 935721109
num_GPU = 1

## lesion insertion
# insert_cmd = 'python lesion_insert.py {0:} {1:} {2:} {3:}'.format(fetch_seed, phantom_type, dataset_root_folder, 3)
# print(insert_cmd)
...
xray_cmd = 'python MCGPU.py {0:} {1:} {2:} {3:} {4:} {5:} {6:}'.format(fetch_seed, phantom_type, dataset_root_folder, num_GPU, 4.24, 0, 0)
print(xray_cmd)
os.system(xray_cmd)
...
xray_cmd = 'python MCGPU.py {0:} {1:} {2:} {3:} {4:} {5:} {6:}'.format(fetch_seed, phantom_type, dataset_root_folder, num_GPU, 4.24, 1, 0)
print(xray_cmd)
os.system(xray_cmd)
