...
#### date: 02/26/2020, modified for creating a singularity container
...
phantom_set_folder = os.path.expanduser('/scratch/xray_set/02-phantom_set')
...
for i in range(len(patient_list)):
	...
	indx = random.randint(0, len(patient_list)-1)
	print('The {0:} in the {1:} phantoms'.format(indx,len(patient_list)))
	fetch_ = patient_list[indx]
