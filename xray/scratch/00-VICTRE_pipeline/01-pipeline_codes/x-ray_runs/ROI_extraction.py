...
# template_flatfield_folder = os.path.expanduser('/shared/aristotle/Phantom/00-VICTRE_pipeline/00-base_input_files/03-DBTrecon_files/flatfield')
roi_cmd_folder = os.path.expanduser('/scratch/00-VICTRE_pipeline/01-pipeline_codes/x-ray_runs/roi_extraction_cmd')
template_flatfield_folder = os.path.expanduser('/scratch/00-VICTRE_pipeline/00-base_input_files/03-DBTrecon_files/flatfield')
...
if image_type == 'mammo' and signal_case == 'SA':
	...
	input_data_file = os.path.join(recon_image_folder, 'DBT_{}_recon.raw'.format(rand_seed))
	copyfile(dbt_data_file, input_data_file)
	extract_cmd = 'python2 {0:}/roiExtraction_DBT_FBP_SP.py {1:} 0 60.25 630 0 {2:} {3:} {4:} 0.085 1 {5:} {6:} {7:} 0 0 0 65 109 5 9 2 2 4 4 {8:} {9:} {10:} {11:} {12:} {13:} {14:}'.format(roi_cmd_folder, rand_seed, nx, ny, nz, offsetX, offsetY, offsetZ, elementSpac, phantom_folder, recon_image_folder, flatfield_file_folder, cal_output_folder, mass_output_folder, loc_output_folder)
